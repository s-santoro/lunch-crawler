...
class MLTuningPerceptron(Task):
    ...
    def output(self):
        ...
        return LocalTarget("../data/%s_configID_%s_MLTuningPerceptron.csv" % (prefix, self.configId), format=UTF8)
    ...
    def run(self):
        ...
        gridsearch = GridSearchCV(
            Perceptron(random_state=random_state, n_jobs=-1, class_weight=class_weight),
            params,
            cv = 5, 
            n_jobs = -1,
            scoring="f1")
        ...
        before_tuning = Perceptron(random_state=random_state, n_jobs=-1, class_weight=class_weight)
